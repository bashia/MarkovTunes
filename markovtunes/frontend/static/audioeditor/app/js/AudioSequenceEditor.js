function AudioLayerSequenceEditor(elementContext)
{
    ...
    this.paintEmpty = function paintEmpty(canvasContext)
    {
        ...
        this.paintTextWithShadow("Drag audio file here to upload", canvasContext.canvas.clientWidth / 2.0, canvasContext.canvas.clientHeight / 2.0, "rgba(0,0,0,1)", canvasContext);
